  ...
  if request.method == 'GET':
     ...
     return render(request,'patient/checkdisease/checkdisease.html', {"list2":alphabaticsymptomslist})
      ...
      if (inputno == 0 ) :
        ...
        doctor_specialization = ["Rheumatologist","Cardiologist","ENT specialist","Orthopedist","Neurologist","Allergist/Immunologist","Urologist","Dermatologist","Gastroenterologist"]
